...
<div class="row" >
    <div class="col-sm-12">
        <div class="mx-auto p-4 border-bottom" style="width: 100%;background-image: url({{ asset('image/row_bg.jpg') }}); position: initial; background-repeat: no-repeat; padding-top: 150px; padding-bottom: 0px; background-position: 50% -15.025px; margin-top: 5px;">
...
<div class="row">
    <div class="col-12">
    <a class="d-flex justify-content-xl-center p-4" style="background-color: black;background-image: url({{ asset('image/row_bg.jpg') }}); position: initial;;background-position: center top;background-repeat: no-repeat;background-attachment: scroll;background-size: cover;padding-top:0px;padding-bottom:270px;" href="{{ route ('file.download.index') }}"><p class="lead  border border-primary p-3">Télécharger la charte JESCT</p></a>
    </div>
</div>
...
<div class="row p-4 text-center displaynone mb-3" id="offerID">
    <div class="col-12">
