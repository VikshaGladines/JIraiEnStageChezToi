  ...
  <header class="container-fluid">
      <div class="row mt-1">
            ...
            <div class="col-2 m-1 " style="height: 120px;">
              <a class="d-flex justify-content-center " href="{{ route('admin.home') }}"><img class="logo align-self-center" src="{{ asset('image/logo_anesf.png') }}"></a>
            </div>
            <div class="col-2 m-1 bg-Ableu " style="height: 120px;">
              ...
              <div class="d-flex justify-content-center"> 
                <svg class="mt-2" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 172 172"  width="55" height="55"
            ...
            <div class="col-2 m-1 bg-Avert " style="height: 120px;">
              ...
              <div class="d-flex justify-content-center">
                <svg class="mt-2" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="55" height="55" viewBox="0 0 172 172"
          ...
          @else
              <div class="d-flex justify-content-center">
                <img class="mt-4" style="position: relative; bottom: 20px;witdh: 55px; height: 55px;"src="https://img.icons8.com/color/48/000000/test-account.png"/>
              </div>
          @endif
